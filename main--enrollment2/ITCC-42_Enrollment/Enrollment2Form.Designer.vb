...
Partial Class Enrollment2Form
    ...
    Private Sub InitializeComponent()
        ...
        resources.ApplyResources(Me.Sidebar, "Sidebar")
        ...
        'AddStaffSBar
        '
        resources.ApplyResources(Me.AddStaffSBar, "AddStaffSBar")
        Me.AddStaffSBar.Name = "AddStaffSBar"
        '
        'SearchSBar
        '
        resources.ApplyResources(Me.SearchSBar, "SearchSBar")
        Me.SearchSBar.Name = "SearchSBar"
        '
        'ClassListSBar
        '
        resources.ApplyResources(Me.ClassListSBar, "ClassListSBar")
        Me.ClassListSBar.Name = "ClassListSBar"
        '
        'EnrollmentSBar
        '
        resources.ApplyResources(Me.EnrollmentSBar, "EnrollmentSBar")
        ...
        'SearchPB
        '
        resources.ApplyResources(Me.SearchPB, "SearchPB")
        Me.SearchPB.Name = "SearchPB"
        Me.SearchPB.TabStop = False
        '
        'AddStaffPB
        '
        resources.ApplyResources(Me.AddStaffPB, "AddStaffPB")
        Me.AddStaffPB.Name = "AddStaffPB"
        Me.AddStaffPB.TabStop = False
        '
        'CListPB
        '
        resources.ApplyResources(Me.CListPB, "CListPB")
        Me.CListPB.Name = "CListPB"
        Me.CListPB.TabStop = False
        '
        'EnrollmentPB
        '
        resources.ApplyResources(Me.EnrollmentPB, "EnrollmentPB")
        Me.EnrollmentPB.Name = "EnrollmentPB"
        Me.EnrollmentPB.TabStop = False
        '
        'EnrolleeName
        '
        resources.ApplyResources(Me.EnrolleeName, "EnrolleeName")
        Me.EnrolleeName.Name = "EnrolleeName"
        '
        'YearLevelBox
        '
        Me.YearLevelBox.FormattingEnabled = True
        resources.ApplyResources(Me.YearLevelBox, "YearLevelBox")
        ...
        resources.ApplyResources(Me.SectionBox, "SectionBox")
        ...
        resources.ApplyResources(Me.StudentsDTB, "StudentsDTB")
        ...
        'SlotsLeftLabel
        '
        resources.ApplyResources(Me.SlotsLeftLabel, "SlotsLeftLabel")
        ...
        'NoStudentsLabel
        '
        resources.ApplyResources(Me.NoStudentsLabel, "NoStudentsLabel")
